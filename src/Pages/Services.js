      ...
      <div className="2xl:mt-20 mt-24 pb-10 md:px-20 sm:px-10 px-5">
        ...
        <div className="gap-4 2xl:px-40 pt-10 flex flex-col">
          <div className="bg-[#f7f7f799] rounded-xl px-7 py-8 shadow">
            ...
            <h3 className="pt-1 text-primary font-bold xl:text-2xl lg:text-lg md:text-xl sm:text-lg text-base text_raleway">
          ...
          <div className="bg-[#f7f7f799] rounded-xl px-7 py-8 shadow">
            ...
            <h3 className="pt-1 text-primary font-bold xl:text-2xl lg:text-lg md:text-xl sm:text-lg text-base text_raleway">
              Overhead Crane Systems for Material Handling/Lifting Solution
            </h3>
          </div>
          <div className="bg-[#f7f7f799] rounded-xl px-7 py-8 shadow">
            <h5 className="font-medium pb-3 2xl:text-2xl xl:text-2xl md:text-xl sm:text-base text-sm text_raleway">
